...
const HeroSection = ({ isDarkMode, setIsReferralPopupOpen }) => {
  ...
  const getTokenIcon = (token) => {
    switch (token) {
      case "ETH":
        return <img src="/sepolia.svg" className="w-5 h-5" alt="sepolia" />;
      default:
        return null;
    }
  };
                ...
                {isConnected ? (
                  <>
                    ...
                    <button
                      ...
                      className={`hidden lg:flex w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 hover:from-fuchsia-600 hover:to-purple-700 text-white rounded-lg py-4 mb-4 items-center justify-center transition-all duration-300 font-medium shadow-lg`}
                    >
                      <img
                        src="/logo.png"
                        alt={TOKEN_SYMBOL}
